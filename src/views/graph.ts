...
import { PostMeta } from "../utils/meta.js";
...
export class PersonalGraph extends LitElement {
  ...
  async buildGraph() {
    ...
    graphics
      ...
      .placeNode((nodeUI, pos: { x: number; y: number }) => {
        nodeUI.attr(
          "transform",
  ...
  setupListener(node, link, target?: string) {
  ...
  _exploreTree(graph, root: Object, parent: string | undefined = undefined) {
